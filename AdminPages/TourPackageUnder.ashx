<%@ WebHandler Language="C#" Class="TourPackageUnder" %>
...
public class TourPackageUnder : IHttpHandler {

    public void ProcessRequest (HttpContext context) {
        context.Response.ContentType = "text/plain";
        int package = Convert.ToInt32(context.Request.QueryString["Amount"]);
        int packid=Convert.ToInt32(context.Request.QueryString["packid"]);
        string flag=Convert.ToString(context.Request.QueryString["flag"]);
        string status = "";
