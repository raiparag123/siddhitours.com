<%@ WebHandler Language="C#" Class="TripImageHandler" %>
...
public class TripImageHandler : IHttpHandler {

    public void ProcessRequest (HttpContext context) {
        context.Response.ContentType = "text/plain";
        int tripID =Convert.ToInt32 (context.Request.QueryString["TripId"]);
        string status = "";
        ...
        try
        {
...

            {
...

                {
                    ...
                    string FileName = context.Server.MapPath("~/Images/TripImages/" + DateTime.Now.ToString("yyyyMMddHHmmss") + "_" + Files);
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        compress =  ConfigurationManager.AppSettings["filePath"]+"CompressedTripImages/" + DateTime.Now.ToString("yyyyMMddHHmmss") + "_" + Files;
                    ...
                    SqlCommand cmd = new SqlCommand("SP_INSERT_TRIP_IMAGES", con);
