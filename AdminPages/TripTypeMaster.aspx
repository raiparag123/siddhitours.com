<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/AdminMasterPage.master" AutoEventWireup="true" CodeFile="TripTypeMaster.aspx.cs" Inherits="AdminPages_TripTypeMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../AdminContent/JS/TripType.js"></script>
</asp:Content>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="trip-category">Trip Category Title</label>
                            <input type="text" class="form-control" id="txtTripType" />
