<%@ WebHandler Language="C#" Class="CruiseImageHandler" %>
...
public class CruiseImageHandler : IHttpHandler
{
        ...
        try
        {
            if (context.Request.Files.Count > 0)
            {
                ...
                for (int i = 0; i < SelectedFiles.Count; i++)
                {
                    ...
                    string FileName = context.Server.MapPath("~/Images/CruiseImages/" + DateTime.Now.ToString("yyyyMMddHHmmss") + "_" + PostedFile.FileName);
                    ...
                    {
                        compress = ConfigurationManager.AppSettings["filePath"] + "/CompressedCruiseImages/" + DateTime.Now.ToString("yyyyMMddHHmmss") + "_" + PostedFile.FileName;
                        ...
                        SqlCommand cmd = new SqlCommand("SP_INSERT_CRUISE_IMAGES", con);
