...
public partial class AdminPages_MailDetail : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string UpdateMailDetail(string DisplayName, string EmailId)
    {
        string status = "";
        AdminPages_MailDetail adm = new AdminPages_MailDetail();
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_UPDATE_MAIL_DETAIL", con);
