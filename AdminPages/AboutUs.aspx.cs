...
public partial class AdminPages_AboutUs : System.Web.UI.Page
{
    ...
    public void getAbout()
    {
        ...
        string status = "";
        AdminPages_AboutUs adm = new AdminPages_AboutUs();
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_FE_ABOUTUS", con);
            ...
            if (ds.Rows.Count > 0)
            {
                aboutus.InnerText = ds.Rows[0][0].ToString();
            }
    ...
    [WebMethod]
    public static string UpdateAboutUs(string Content)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_UPDATE_ABOUTUS", con);
            cmd.CommandType = CommandType.StoredProcedure;
