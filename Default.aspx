...
<body>
  ...
  <li><input type="radio" name="currency" value="DOLLAR"> DOLLAR<br></li>
                    ...
                    <li>
						<div class="switch" >
						  <input type="radio" class="switch-input" name="currencyTOP" value="INR" id="INR" checked>
						  <label for="INR" class="switch-label switch-label-off"><i class="fa fa-inr"></i></label>
						  <input type="radio" class="switch-input" name="currencyTOP" value="DOLLAR" id="DLR">
						  <label for="DLR" class="switch-label switch-label-on"><i class="fa fa-dollar"></i></label>
