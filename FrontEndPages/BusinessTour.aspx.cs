...
public partial class FrontEndPages_BusinessTour : System.Web.UI.Page
{
    ...
    public static string getTourList()
    {
        ...
        FrontEndPages_BusinessTour adm = new FrontEndPages_BusinessTour();
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_FE_BUSINESSTOUR_LIST_FRONT", con);
