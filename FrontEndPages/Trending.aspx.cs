...
public partial class FrontEndPages_Trending : System.Web.UI.Page
{
    ...
    public static string getTrending()
    {
        ...
        FrontEndPages_Trending adm = new FrontEndPages_Trending();
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_FE_TRENDING_FRONT", con);
