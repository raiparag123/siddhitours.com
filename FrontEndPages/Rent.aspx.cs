...
public partial class FrontEndPages_Rent : System.Web.UI.Page
{
    ...
    public static string getRent()
    {
        ...
        FrontEndPages_Rent adm = new FrontEndPages_Rent();
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_FE_RENT_FRONT", con);
    ...
    public static string getLocation()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_FE_RENT_LOCATION_FRONT", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    public static string getVehicle()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_FE_RENT_VEHICLE_FRONT", con);
            cmd.CommandType = CommandType.StoredProcedure;
    ...
    public static string SendMail(string Rent, string Email, string Phone)
    {
        FrontEndPages_Rent adm = new FrontEndPages_Rent();
        string status = "";
        try
        {
            ...
            Ebody += "<tr><th>Email</th><th>Phone</th><th>Rent</th></tr>";
            Ebody += "<tr><td>" + Email + "</td><td>" + Phone + "</td><td>" + Rent + "</td></tr></table>";
